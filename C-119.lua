...
F_104T =  {
	...
	Picture 			= "../../../../../Mods/aircrafts/C-119/C-119.png",
	...
	{
		{
			...
			desrt    = 'C-119_destr'; -- Name of destroyed object file name
	...
	DamageParts = 
	{  
--DAMAGEOFF		[1] = "C-119-part-wing-R", -- wing R
--DAMAGEOFF		[2] = "C-119-part-wing-L", -- wing L
--DAMAGEOFF		[3] = "C-119-part-nose", -- nose
--DAMAGEOFF		[4] = "C-119-part-tail", -- tail
	},
